"""Represent AWS config_access settings"""
import json
...
#     """Represent a collection of config_access settings on AWS"""
#     def __init__(self):
...
#         """Get config_access for setting up data access
#
...
#         """Get config_access for setting up data publish
#
...
#
# class AwsS3Session:
#     def __int__(self, bucket_name: str, key_name: str):
#         """Represent on AWS S3 session
#
...
#         """Get and return content of the key in bucket"""
#         s3_object = self._s3.Object(bucket_name=self._bucket_name,
#                                     key=self._key_name)
#         return s3_object.get()['Body'].read()
#
#
# class AwsAppConfigSession:
#     """Represent an AWS app config_access session"""
